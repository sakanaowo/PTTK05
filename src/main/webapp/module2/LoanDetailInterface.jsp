    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <c:if test="${not empty loanSlip}">
                ...
                <c:if test="${not empty loanDetailList}">
                    <h3>Danh sách tài liệu (${loanDetailList.size()} tài liệu)</h3>
                    <table class="data-table">
                        ...
                        <tbody>
                            <c:forEach var="detail" items="${loanDetailList}">
                                <tr>
